...
const RepairPackageCard = ({ aPackage, dictionary }) => (
  ...
  <div className="flex-shrink-0 w-full sm:w-1/2 lg:w-1/3 min-w-0 px-4">
    <div className="flex flex-col bg-white h-full rounded-lg shadow-lg p-4 sm:p-6 border-t-8 border-yellow-400">
      ...
      {/* REVISI: Area scroll untuk detail paket, menggantikan accordion */}
      <div className="flex-grow overflow-y-auto max-h-[300px] pr-2 space-y-4 border-t pt-4">
        <ListSection
          title={dictionary.serviceDetails}
          items={aPackage.service_details}
        />
        <ListSection
          title={dictionary.inspectionDetails}
          items={aPackage.inspection_details}
        />
...
export default RepairPackagesSlider;
