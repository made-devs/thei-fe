  ...
  return (
    <section className="relative h-[82vh] overflow-hidden">
      ...
      <div className="container mx-auto lg:-mt-10 px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10 h-full flex flex-col justify-center items-center text-center">
        {/* Brand Text */}
        <p className="text-yellow-400 text-xs sm:text-sm md:text-base font-semibold tracking-widest uppercase mb-8 sm:mb-10 animate-fade-in">
          {brand_text}
        </p>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <p className="text-yellow-400 text-base sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-wider uppercase">
            {subheadline1}
          </p>
          ...
          <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-yellow-400 tracking-tight leading-tight animate-pulse-glow">
            {headline_highlight}
          </h2>

          {/* Line 3 - HANYA DI THEI */}
          <p className="text-yellow-400 text-base sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-wider uppercase mt-4">
            {headline_line3}
          </p>
        </div>
      </div>
