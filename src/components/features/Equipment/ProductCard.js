        ...
        <div className="mt-auto pt-2 sm:pt-4 border-t border-gray-100 space-y-2 sm:space-y-3">
          <div className="flex items-center">
            <input
              ...
              disabled={isDisabled}
              className="h-3 w-3 sm:h-4 sm:w-4 rounded border-gray-300 text-yellow-500 focus:ring-yellow-500 disabled:opacity-50 cursor-pointer"
            />
            <label
