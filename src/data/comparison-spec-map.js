export const specMap = {
  ...
  'reach-stacker': [
    ...
    { label: 'Type', path: 'type' },
    { label: 'Engine Model', path: 'engine.model' },
    { label: 'Transmission', path: 'transmission.model' },
    { label: 'Drive Axle', path: 'drive_axle.model' },
    { label: 'Hydraulic Pump', path: 'hydraulic_system.pump' },
    ...
    { label: 'Spreader Model', path: 'performance.spreader' },
    { label: 'Overall Weight', path: 'dimensions_and_weight.overall_weight' },
    { label: 'Wheel Base', path: 'dimensions_and_weight.wheel_base' },
    {
      label: 'Min Turning Radius',
      path: 'dimensions_and_weight.min_turning_radius',
    },
    { label: 'Tyre Size', path: 'dimensions_and_weight.tyre' },
  ],
