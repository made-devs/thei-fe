...
const dictionaries = {
  en: {
    ...
    parts: () => import('../dictionaries/en/parts.json').then((m) => m.default),
    promotions: () =>
      import('../dictionaries/en/promotions.json').then((m) => m.default),
    'repair-packages': () =>
      import('../dictionaries/en/repair-packages.json').then((m) => m.default),
    rental: () =>
    ...
    'why-buy-forklift': () =>
      import('../dictionaries/en/why-buy-forklift.json').then((m) => m.default),
    career: () =>
  ...
  id: {
    ...
    parts: () => import('../dictionaries/id/parts.json').then((m) => m.default),
    promotions: () =>
      import('../dictionaries/id/promotions.json').then((m) => m.default),
    'repair-packages': () =>
      import('../dictionaries/id/repair-packages.json').then((m) => m.default),
    rental: () =>
    ...
    'why-buy-forklift': () =>
      import('../dictionaries/id/why-buy-forklift.json').then((m) => m.default),
    career: () =>
